...
class TheyAlsoUseCell: UITableViewCell, RegisterCell {
    ...
    override func awakeFromNib() {
        ...
        collectionView.cs_register(cell: TheyUseCollectionCell.self)
    }
...
extension TheyAlsoUseCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.cs_dequeueReusableCell(cell: TheyUseCollectionCell.self, indexPath: indexPath) as TheyUseCollectionCell
