...
extension SmallVideoViewController {
    ...
    func setupUI() {
        ...
        collectionView.cs_register(cell: SmallVideoCell.self)
...
extension SmallVideoViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.cs_dequeueReusableCell(cell: SmallVideoCell.self, indexPath: indexPath) as SmallVideoCell
