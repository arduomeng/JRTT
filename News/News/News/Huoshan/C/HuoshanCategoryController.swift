...
class HuoshanCategoryController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.cs_register(cell: HuoshanCell.self)
        // 添加刷新控件
        setRefresh()
    }
...
extension HuoshanCategoryController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.cs_dequeueReusableCell(cell: HuoshanCell.self, indexPath: indexPath) as HuoshanCell
